...
public class JwtUtilService {
    ...
    public boolean validateToken(String token, UsuarioSecurity usuarioSecurity) {
        String correo = extractUsername(token);
        return (!isTokenExpired(token)) && (correo.equals(usuarioSecurity.getUsername()));
    }
    ...
    public String generateToken(UsuarioSecurity usuarioSecurity) {
        ...
        claims.put("usuario_id", usuarioSecurity.getUsuario().getId());
